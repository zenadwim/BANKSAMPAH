                    ...
                    <div class="mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                $sql = "SELECT * FROM harga_pengepul INNER JOIN admin ON harga_pengepul.id_admin=admin.id_admin INNER JOIN sampah ON harga_pengepul.id_sampah=sampah.id_sampah ORDER BY harga_pengepul.tanggal DESC ;";
