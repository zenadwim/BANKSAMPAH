                        ...
                        <div class="d-flex justify-content-center"> 
                            <div class="col-md-8">
                                <table>
                                    ...
                                    <td style="display:none">  <input type="text" name="id_nasabah" id="id_nasabah" class="form-control" value="<?php echo $id_nasabah; ?>" />  </td>
    ...
    <script>  
        $(document).ready(function(){  
            ...
            $('#filter').click(function(){  
                ...
                {  
                    $.ajax({  
                        url:"filter_infopenabung.php",  
                        method:"POST",  
                        data:{from_date:dari, to_date:ke, id_nasabah:id_nasabah},  
